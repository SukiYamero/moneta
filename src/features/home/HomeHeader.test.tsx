...
describe('HomeHeader', () => {
  ...
  // A guest (specs.md §10.10) has no Google profile — `user` stays null past
  // RequireAuth's guard, unlike an authenticated session. The header must
  // show an honest guest label, not a blank name and a blank avatar.
